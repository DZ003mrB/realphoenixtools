...
def interactive():
    ...
    print("\r\n[+] Masukkan informasi tentang target untuk mendapat wordlist")
    print("[+] jika kamu tidak mengetahui tentang informasi yang diminta tekan saja enter ;)\r\n")

    # kami membutuhkan informasi terlebih dahulu!
